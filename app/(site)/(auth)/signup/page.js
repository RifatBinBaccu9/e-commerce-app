...
<Checkbox onChange={onChange}></Checkbox>
        ...
        <span className=' text-sm font-normal '>Are you agree to Clicon <span className='text-[#2DA5F3]'><Link href={'#'} >Terms of Condition</Link></span> and <span className='text-[#2DA5F3]'><Link href={'#'} >Privacy Policy</Link></span>.
            ...
            <Link href={"/verifyemail"} className='flex flex-row items-center justify-center gap-2 text-sm font-bold bg-[#FA8232] text-white rounded-[2px] w-full h-[44px] uppercase mt-5'><span className='text-white'>Sign in</span> <FaArrowRight className='text-white'/></Link>

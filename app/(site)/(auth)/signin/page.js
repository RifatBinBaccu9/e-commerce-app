    ...
    <div className='px-[32px] py-6'>
      ...
      >
        {showPassword ? <BsEye /> : <BsEyeSlash /> }
            ...
            <button className='flex flex-row items-center justify-center gap-2 text-sm font-bold bg-[#FA8232] text-white rounded-[2px] w-full h-[44px] uppercase mt-5'><span>Sign in</span> <FaArrowRight /></button>

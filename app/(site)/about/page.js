...
const About = () => {
  return (
    <div className=' '>
      ...
      <div className=''>
        <div className=' text-white z-30 w-full h-[424px] bg-cover bg-no-repeat' style={{ backgroundImage: 'url(/bgabout.jfif)' } }>

         <div className='container pt-[88px]'>
         <div className='w-full sm:w-[424px] h-full'>
            <h1 className='text-[32px] font-semibold'>Your trusted and reliable retail shop</h1>
            <p className='text-lg font-normal mt-4 mb-6'>Praesent sed semper metus. Nunc aliquet dolor mauris, et fringilla elit gravida eget. Nunc consequat auctor urna a placerat.</p>

            <div className='w-[50px] sm:w-[72px] h-[50px] sm:h-[72px] p-3 sm:p-6 bg-[#FA8232] rounded-full'>
                <Image src={'/Play.png'} alt='imga' width={50} height={50} className='w-full h-full'/>
            </div>
          </div>
         </div>
        </div>
